...
namespace JStudio.OpenGL
{
    ...
    public static class GXToOpenGL
    {
        ...
        public static BlendingFactor GetBlendFactorSrc(GXBlendModeControl sourceFactor)
        {
            switch (sourceFactor)
            {
                case GXBlendModeControl.Zero: return BlendingFactor.Zero;
                case GXBlendModeControl.One: return BlendingFactor.One;
                case GXBlendModeControl.SrcColor: return BlendingFactor.SrcColor;
                case GXBlendModeControl.InverseSrcColor: return BlendingFactor.OneMinusSrcColor;
                case GXBlendModeControl.SrcAlpha: return BlendingFactor.SrcAlpha;
                case GXBlendModeControl.InverseSrcAlpha: return BlendingFactor.OneMinusSrcAlpha;
                case GXBlendModeControl.DstAlpha: return BlendingFactor.DstAlpha;
                case GXBlendModeControl.InverseDstAlpha: return BlendingFactor.OneMinusDstAlpha;
                default:
        ...
        public static BlendingFactor GetBlendFactorDest(GXBlendModeControl destinationFactor)
        {
